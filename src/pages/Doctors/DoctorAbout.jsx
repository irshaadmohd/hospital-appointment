    ...
    <div>
      <div>
        ...
        <p className="text__para">
          ...
          alias delectus atque asperiores. Voluptatum suscipit voluptate saepe,
          officia hic necessitatibus corrupti, accusamus rerum earum cumque
          autem veniam! Atque, velit!
        </p>
      </div>
      ...
      <div className="mt-12">
        ...
        <ul className="pt-4 md:p-5 ">
          ...
          <li className="flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 md-[30px]">
            <div>
              <span className="text-irisBlueColor text-[15px] leading-6 font-semibold">
                {formateDate("12-04-2010")} - {formateDate("09-07-2014")}
              </span>
